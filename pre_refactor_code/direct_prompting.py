...
def generate_final_prompts(
    outputs,
    processor,
    answer_prompt="So the final answer should be"
):
    final_prompts = list()
...
def main():
    ...
    with open("alex/test_direct.txt", 'w') as output_file, open("alex/ans_direct.txt", 'w') as answer_file, open(data_path, 'r') as data_file:
